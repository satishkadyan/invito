...
/**
 * This is an exception which is thrown when a unimplemented method/operation is
 * called. Such methods will be implemented in the future releases.
 * 
 * @author Admin
 * 
 */
public class NotImplementedException extends InvitoSystemException {
